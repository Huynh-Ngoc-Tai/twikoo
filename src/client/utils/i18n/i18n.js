...
export default {
  ADMIN_CLIENT_VERSION: [
    ...
    'クライアントバージョン：',
    '클라이언트 버전: ',
    viTranslations.ADMIN_CLIENT_VERSION
  ],
  ADMIN_SERVER_VERSION: [
    ...
    'サーバーサイドバージョン: ',
    '서버 버전: ',
    viTranslations.ADMIN_SERVER_VERSION
  ],
  [S.AC]: [
    '评论管理',
    '評論管理',
  ...
  [S.AC + '_DELETE']: [
    ...
    '削除',
    '삭제',
    viTranslations.ADMIN_COMMENT_DELETE
  ],
  [S.AC + '_DELETE_CONFIRM']: [
    ...
    '本当に削除しますか？',
    '정말 삭제하시겠습니까?',
    viTranslations.ADMIN_COMMENT_DELETE_CONFIRM
  ],
  [S.AC + '_FILTER_ALL']: [
    '全部',
    '全部',
    ...
    '全部',
    '전체',
    viTranslations.ADMIN_COMMENT_FILTER_ALL
  ],
  [S.AC + '_FILTER_VISIBLE']: [
    ...
    '表示中のみ',
    '표시 댓글',
    viTranslations.ADMIN_COMMENT_FILTER_VISIBLE
  ],
  [S.AC + '_FILTER_HIDDEN']: [
    '只看隐藏',
    '只看隱藏',
    ...
    '非表示中のみ',
    '숨김 댓글',
    viTranslations.ADMIN_COMMENT_FILTER_HIDDEN
  ],
  [S.AC + '_HIDE']: [
    '隐藏',
    '隱藏',
    ...
    '非表示',
    '숨기기',
    viTranslations.ADMIN_COMMENT_HIDE
  ],
  [S.AC + '_IS_SPAM_SUFFIX']: [
    ...
    ' (非表示)',
    ' (숨김 처리됨)',
    viTranslations.ADMIN_COMMENT_IS_SPAM_SUFFIX
  ],
  [S.AC + '_SEARCH']: [
    '搜索',
    '搜索',
    ...
    '検索',
    '검색',
    viTranslations.ADMIN_COMMENT_SEARCH
  ],
  [S.AC + '_SEARCH_PLACEHOLDER']: [
    ...
    viTranslations.ADMIN_COMMENT_SEARCH_PLACEHOLDER
  ],
  [S.AC + '_SHOW']: [
    '显示',
    '顯示',
    ...
    '表示',
    '표시',
    viTranslations.ADMIN_COMMENT_SHOW
  ],
  [S.AC + '_TOP']: [
    '置顶',
    '置頂',
    ...
    '固定する',
    '고정',
    viTranslations.ADMIN_COMMENT_TOP
  ],
  [S.AC + '_UNTOP']: [
    '取消置顶',
    '取消置頂',
    ...
    '固定を解除',
    '고정 해제',
    viTranslations.ADMIN_COMMENT_UNTOP
  ],
  [S.AC + '_VIEW']: [
    '查看',
    '查看',
    ...
    '閲覧',
    '보기',
    viTranslations.ADMIN_COMMENT_VIEW
  ],
  ADMIN_CONFIG: [
    '配置管理',
    '配置管理',
  ...
  [S.ACC + '_COMMON']: [
    ...
    '一般',
    '일반',
    viTranslations.ADMIN_CONFIG_CATEGORY_COMMON
  ],
  [S.ACC + '_IM']: [
    '即时通知',
    '即時通知',
    ...
    '即時通知',
    '실시간 알림',
    viTranslations.ADMIN_CONFIG_CATEGORY_IM
  ],
  [S.ACC + '_MAIL']: [
    '邮件通知',
    '郵件通知',
    ...
    'メール通知',
    '이메일 알림',
    viTranslations.ADMIN_CONFIG_CATEGORY_MAIL
  ],
  [S.ACC + '_PLUGIN']: [
    '插件',
    '插件',
    ...
    'プラグイン',
    '플러그인',
    viTranslations.ADMIN_CONFIG_CATEGORY_PLUGIN
  ],
  [S.ACC + '_PRIVACY']: [
    '隐私',
    '隱私',
    ...
    'プライバシー',
    '개인정보',
    viTranslations.ADMIN_CONFIG_CATEGORY_PRIVACY
  ],
  [S.ACC + '_SPAM']: [
    '反垃圾',
    '反垃圾',
    ...
    'スパム対策',
    '스팸 관리',
    viTranslations.ADMIN_CONFIG_CATEGORY_SPAM
  ],
  ADMIN_CONFIG_EMAIL_TEST: [
    ...
    'メール通知テスト',
    '이메일 알림 테스트',
    viTranslations.ADMIN_CONFIG_EMAIL_TEST
  ],
  ADMIN_CONFIG_EMAIL_TEST_BTN: [
    ...
    'テストメールを送信',
    '테스트 메일 발송',
    viTranslations.ADMIN_CONFIG_EMAIL_TEST_BTN
  ],
  ADMIN_CONFIG_EMAIL_TEST_HELP: [
    ...
    viTranslations.ADMIN_CONFIG_EMAIL_TEST_HELP
  ],
  ADMIN_CONFIG_EMAIL_TEST_RESULT: [
    ...
    'テスト結果：',
    '테스트 결과: ',
    viTranslations.ADMIN_CONFIG_EMAIL_TEST_RESULT
  ],
  ADMIN_CONFIG_EXAMPLE: [
    ...
    '例：',
    '예시: ',
    viTranslations.ADMIN_CONFIG_EXAMPLE
  ],
  [S.ACI + '_AKISMET_KEY']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_AKISMET_KEY
  ],
  [S.ACI + '_BLOGGER_NICK']: [
    '博主的昵称。',
    '博主的昵稱。',
    ...
    '管理者の名前。',
    '관리자 닉네임.',
    viTranslations.ADMIN_CONFIG_ITEM_BLOGGER_NICK
  ],
  [S.ACI + '_BLOGGER_EMAIL']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_BLOGGER_EMAIL
  ],
  [S.ACI + '_COMMENT_BG_IMG']: [
    ...
    '댓글창 배경 이미지 URL 주소.',
    viTranslations.ADMIN_CONFIG_ITEM_COMMENT_BG_IMG
  ],
  [S.ACI + '_COMMENT_PAGE_SIZE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_COMMENT_PAGE_SIZE
  ],
  [S.ACI + '_COMMENT_PLACEHOLDER']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_COMMENT_PLACEHOLDER
  ],
  [S.ACI + '_CORS_ALLOW_ORIGIN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_CORS_ALLOW_ORIGIN
  ],
  [S.ACI + '_DEFAULT_GRAVATAR']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_DEFAULT_GRAVATAR
  ],
  [S.ACI + '_EMOTION_CDN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_EMOTION_CDN
  ],
  [S.ACI + '_FORBIDDEN_WORDS']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_FORBIDDEN_WORDS
  ],
  [S.ACI + '_BLOCKED_WORDS']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_BLOCKED_WORDS
  ],
  [S.ACI + '_GRAVATAR_CDN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_GRAVATAR_CDN
  ],
  [S.ACI + '_HIDE_ADMIN_CRYPT']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_HIDE_ADMIN_CRYPT
  ],
  [S.ACI + '_HIGHLIGHT']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_HIGHLIGHT
  ],
  [S.ACI + '_HIGHLIGHT_THEME']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_HIGHLIGHT_THEME
  ],
  [S.ACI + '_HIGHLIGHT_PLUGIN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_HIGHLIGHT_PLUGIN
  ],
  [S.ACI + '_IMAGE_CDN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_IMAGE_CDN
  ],
  // 翻译来自 Deepseek
  [S.ACI + '_IMAGE_CDN_URL']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_IMAGE_CDN_URL
  ],
  [S.ACI + '_IMAGE_CDN_TOKEN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_IMAGE_CDN_TOKEN
  ],
  [S.ACI + '_LIGHTBOX']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_LIGHTBOX
  ],
  [S.ACI + '_LIMIT_PER_MINUTE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_LIMIT_PER_MINUTE
  ],
  [S.ACI + '_LIMIT_PER_MINUTE_ALL']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_LIMIT_PER_MINUTE_ALL
  ],
  [S.ACI + '_LIMIT_LENGTH']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_LIMIT_LENGTH
  ],
  [S.ACI + '_MAIL_SUBJECT']: [
    '自定义通知邮件主题，留空则使用默认主题。',
    '自定義通知郵件主題，留空則使用預設主題。',
    ...
    viTranslations.ADMIN_CONFIG_ITEM_MAIL_SUBJECT
  ],
  [S.ACI + '_MAIL_SUBJECT_ADMIN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_MAIL_SUBJECT_ADMIN
  ],
  [S.ACI + '_MAIL_TEMPLATE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_MAIL_TEMPLATE
  ],
  [S.ACI + '_MAIL_TEMPLATE_ADMIN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_MAIL_TEMPLATE_ADMIN
  ],
  [S.ACI + '_MASTER_TAG']: [
    '博主标识自定义文字，默认为 “博主”。',
    '博主標識自定義文字，預設為 “博主”。',
    ...
    viTranslations.ADMIN_CONFIG_ITEM_MASTER_TAG
  ],
  [S.ACI + '_NOTIFY_SPAM']: [
    '垃圾评论是否发送通知，默认：true',
    '垃圾評論是否發送通知，默認：true',
    ...
    viTranslations.ADMIN_CONFIG_ITEM_NOTIFY_SPAM
  ],
  [S.ACI + '_TURNSTILE_SITE_KEY']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_TURNSTILE_SITE_KEY
  ],
  [S.ACI + '_TURNSTILE_SECRET_KEY']: [
    ...
    'Turnstile CAPTCHA Secret Key',
    viTranslations.ADMIN_CONFIG_ITEM_TURNSTILE_SECRET_KEY
  ],
  [S.ACI + '_QCLOUD_SECRET_ID']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_QCLOUD_SECRET_ID
  ],
  [S.ACI + '_QCLOUD_CMS_BIZTYPE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_QCLOUD_CMS_BIZTYPE
  ],
  [S.ACI + '_QCLOUD_SECRET_KEY']: [
    ...
    'Tencent Cloud Secret Key.',
    viTranslations.ADMIN_CONFIG_ITEM_QCLOUD_SECRET_KEY
  ],
  [S.ACI + '_PUSHOO_CHANNEL']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_PUSHOO_CHANNEL
  ],
  [S.ACI + '_PUSHOO_TOKEN']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_PUSHOO_TOKEN
  ],
  [S.ACI + '_DISPLAYED_FIELDS']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_DISPLAYED_FIELDS
  ],
  [S.ACI + '_REQUIRED_FIELDS']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_REQUIRED_FIELDS
  ],
  [S.ACI + '_SC_MAIL_NOTIFY']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SC_MAIL_NOTIFY
  ],
  [S.ACI + '_SENDER_EMAIL']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SENDER_EMAIL
  ],
  [S.ACI + '_SENDER_NAME']: [
    '邮件通知标题。',
    '郵件通知標題。',
    ...
    'メール通知のタイトル',
    '알림 이메일 발신자 이름.',
    viTranslations.ADMIN_CONFIG_ITEM_SENDER_NAME
  ],
  [S.ACI + '_SHOW_EMOTION']: [
    '启用插入表情功能，默认为：true',
    '啟用插入表情功能，預設為：true',
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SHOW_EMOTION
  ],
  [S.ACI + '_SHOW_IMAGE']: [
    '启用插入图片功能，默认为：true',
    '啟用插入圖片功能，預設為：true',
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SHOW_IMAGE
  ],
  [S.ACI + '_SHOW_UA']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SHOW_UA
  ],
  [S.ACI + '_SHOW_REGION']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SHOW_REGION
  ],
  [S.ACI + '_SITE_NAME']: [
    '网站名称',
    '網站名稱',
    ...
    'ウェブサイト名',
    '웹사이트 이름.',
    viTranslations.ADMIN_CONFIG_ITEM_SITE_NAME
  ],
  [S.ACI + '_SITE_URL']: [
    '网站地址',
    '網站地址',
    ...
    'ウェブサイトのアドレス',
    '웹사이트 주소.',
    viTranslations.ADMIN_CONFIG_ITEM_SITE_URL
  ],
  [S.ACI + '_SMTP_HOST']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_HOST
  ],
  [S.ACI + '_SMTP_PASS']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_PASS
  ],
  [S.ACI + '_SMTP_PORT']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_PORT
  ],
  [S.ACI + '_SMTP_SECURE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_SECURE
  ],
  [S.ACI + '_SMTP_SERVICE']: [
    ...
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_SERVICE
  ],
  [S.ACI + '_SMTP_USER']: [
    '邮件通知邮箱用户名。',
    '郵件通知郵箱用户名。',
    ...
    'メール通知のメールボックスユーザー名。',
    '선택한 이메일 알림 서비스 아이디',
    viTranslations.ADMIN_CONFIG_ITEM_SMTP_USER
  ],
  ADMIN_CONFIG_RESET: [
    '重置',
    '重置',
    ...
    'リセット',
    '초기화',
    viTranslations.ADMIN_CONFIG_RESET
  ],
  ADMIN_CONFIG_SAVE: [
    '保存',
    '保存',
    ...
    '保存',
    '저장',
    viTranslations.ADMIN_CONFIG_SAVE
  ],
  ADMIN_CREDENTIALS: [
    '私钥文件',
    '私鑰文件',
    ...
    '秘密鍵ファイル',
    '개인 키 파일',
    viTranslations.ADMIN_CREDENTIALS
  ],
  ADMIN_CREDENTIALS_FAQ: [
    ...
    '秘密鍵を取得する方法',
    '개인 키 발급 방법',
    viTranslations.ADMIN_CREDENTIALS_FAQ
  ],
  ADMIN_CREDENTIALS_PLACEHOLDER: [
    ...
    '개인 키 파일 내용을 붙여넣으세요',
    viTranslations.ADMIN_CREDENTIALS_PLACEHOLDER
  ],
  ADMIN_FORGOT: [
    '忘记密码',
    '忘記密碼',
  ...
  ADMIN_EXPORT_WARN: [
    ...
    viTranslations.ADMIN_EXPORT_WARN
  ],
  ADMIN_EXPORT_COMMENT: [
    ...
    'コメントをエクスポート',
    '댓글 내보내기',
    viTranslations.ADMIN_EXPORT_COMMENT
  ],
  ADMIN_EXPORT_COUNTER: [
    ...
    'ページビューをエクスポート',
    '통계 내보내기',
    viTranslations.ADMIN_EXPORT_COUNTER
  ],
  [S.AI]: [
    '导入',
    '匯入',
  ...
  [S.AI + '_FILE_REQUIRED']: [
    ...
    'ファイルが選択されていません',
    '파일이 선택되지 않았습니다',
    viTranslations.ADMIN_IMPORT_FILE_REQUIRED
  ],
  [S.AI + '_IMPORTED']: [
    '完成导入 ',
    '完成匯入 ',
    ...
    'インポート完了 ',
    '가져오기 완료 ',
    viTranslations.ADMIN_IMPORT_IMPORTED
  ],
  [S.AI + '_IMPORTING']: [
    '开始导入 ',
    '開始匯入 ',
    ...
    'インポートを開始 ',
    '가져오는 중 ',
    viTranslations.ADMIN_IMPORT_IMPORTING
  ],
  [S.AI + '_LOG']: [
    '日志',
    '日誌',
    ...
    'システムログ',
    '로그',
    viTranslations.ADMIN_IMPORT_LOG
  ],
  [S.AI + '_SELECT']: [
    '请选择',
    '請選擇',
    ...
    '選択してください',
    '선택하세요',
    viTranslations.ADMIN_IMPORT_SELECT
  ],
  [S.AI + '_SELECT_FILE']: [
    '选择文件',
    '選擇文件',
    ...
    'ファイルを選択',
    '파일 선택',
    viTranslations.ADMIN_IMPORT_SELECT_FILE
  ],
  [S.AI + '_SELECT_SOURCE']: [
    '选择源系统',
    '選擇源系統',
    ...
    'ソースを選択',
    '가져올 댓글 데이터 선택',
    viTranslations.ADMIN_IMPORT_SELECT_SOURCE
  ],
  [S.AI + '_SOURCE_REQUIRED']: [
    ...
    viTranslations.ADMIN_IMPORT_SOURCE_REQUIRED
  ],
  [S.AI + '_START']: [
    '开始导入',
    '開始匯入',
    ...
    'インポートを開始',
    '가져오기 시작',
    viTranslations.ADMIN_IMPORT_START
  ],
  [S.AI + '_STARTING']: [
    '开始导入',
    '開始匯入',
    ...
    'インポート中です',
    '가져오는 중',
    viTranslations.ADMIN_IMPORT_STARTING
  ],
  [S.AI + '_TIP_ARTALK']: [
    ...
    viTranslations.ADMIN_IMPORT_TIP_ARTALK
  ],
  [S.AI + '_TIP_DISQUS']: [
    ...
    viTranslations.ADMIN_IMPORT_TIP_DISQUS
  ],
  [S.AI + '_TIP_VALINE']: [
    ...
    viTranslations.ADMIN_IMPORT_TIP_VALINE
  ],
  [S.AI + '_UPLOADED']: [
    '上传完成 ',
    '上傳完成 ',
    ...
    'アップロード完了',
    '업로드 완료 ',
    viTranslations.ADMIN_IMPORT_UPLOADED
  ],
  [S.AI + '_UPLOADING']: [
    '已上传 ',
    '已上傳 ',
    ...
    'アップロード中です',
    '업로드 중 ',
    viTranslations.ADMIN_IMPORT_UPLOADING
  ],
  [S.AI + '_WARN']: [
    ...
    viTranslations.ADMIN_IMPORT_WARN
  ],
  ADMIN_LOGIN: [
    '登录',
    '登入',
  ...
  ADMIN_LOGIN_TITLE: [
    ...
    'Twikoo コメント管理',
    'Twikoo 관리자 패널',
    viTranslations.ADMIN_LOGIN_TITLE
  ],
  ADMIN_LOGOUT: [
    '退出登录',
    '退出登入',
  ...
  ADMIN_NEED_UPDATE: [
    ...
    viTranslations.ADMIN_NEED_UPDATE
  ],
  ADMIN_PASSWORD: [
    '密码',
    '密碼',
  ...
  ADMIN_PASSWORD_PLACEHOLDER: [
    ...
    '入力してください',
    '비밀번호를 입력하세요...',
    viTranslations.ADMIN_PASSWORD_PLACEHOLDER
  ],
  ADMIN_PASSWORD_REQUIRED: [
    ...
    'パスワードを入力してください',
    '비밀번호를 입력하세요',
    viTranslations.ADMIN_PASSWORD_REQUIRED
  ],
  ADMIN_REGIST: [
    '注册',
    '註冊',
  ...
  ADMIN_REGIST_FAILED: [
    ...
    '登録に失敗しました',
    '관리자 등록 실패',
    viTranslations.ADMIN_REGIST_FAILED
  ],
  ADMIN_SET_PASSWORD: [
    '设置密码',
    '設置密碼',
    ...
    'パスワードの設定',
    '비밀번호 설정',
    viTranslations.ADMIN_SET_PASSWORD
  ],
  ADMIN_SET_PASSWORD_CONFIRM: [
    ...
    'パスワードの確認',
    '비밀번호 확인',
    viTranslations.ADMIN_SET_PASSWORD_CONFIRM
  ],
  ADMIN_SET_PASSWORD_CONFIRM_PLACEHOLDER: [
    ...
    'パスワードの確認',
    '비밀번호 확인...',
    viTranslations.ADMIN_SET_PASSWORD_CONFIRM_PLACEHOLDER
  ],
  ADMIN_SET_PASSWORD_PLACEHOLDER: [
    ...
    'パスワード',
    '비밀번호',
    viTranslations.ADMIN_SET_PASSWORD_PLACEHOLDER
  ],
  ADMIN_TITLE: [
    'Twikoo 管理面板',
    'Twikoo 管理面板',
  ...
  COMMENTS_COUNT_SUFFIX: [
    ...
    ' 件のコメント',
    '개의 댓글',
    viTranslations.COMMENTS_COUNT_SUFFIX
  ],
  COMMENTS_EXPAND: [
    '查看更多',
    '查看更多',
    ...
    'もっと見る',
    '더 보기',
    viTranslations.COMMENTS_EXPAND
  ],
  COMMENTS_NO_COMMENTS: [
    ...
    'コメントはありません',
    '아직 댓글이 없습니다.',
    viTranslations.COMMENTS_NO_COMMENTS
  ],
  COMMENT_EXPAND: [
    '展开',
    '展開',
  ...
  COMMENT_COLLAPSE: [
    ...
    '折りたたむ',
    '접기',
    viTranslations.COMMENT_COLLAPSE
  ],
  COMMENT_MASTER_TAG: [
    '博主',
    '博主',
    ...
    '管理者',
    '관리자',
    viTranslations.COMMENT_MASTER_TAG
  ],
  COMMENT_REPLIED: [
    '回复',
    '回覆',
    ...
    '返信',
    '답글',
    viTranslations.COMMENT_REPLIED
  ],
  COMMENT_REVIEWING_TAG: [
    ...
    '検討中',
    '검토 중',
    viTranslations.COMMENT_REVIEWING_TAG
  ],
  COMMENT_TOP_TAG: [
    '置顶',
    '置頂',
    ...
    '固定',
    '고정됨',
    viTranslations.COMMENT_TOP_TAG
  ],
  COMMENT_FAILED: [
    '评论失败',
    '評論失敗',
  ...
  META_INPUT_LINK: [
    ...
    'ウェブサイト',
    '웹사이트',
    viTranslations.META_INPUT_LINK
  ],
  META_INPUT_MAIL: [
    '邮箱',
    '郵箱',
    ...
    'メールアドレス',
    '이메일',
    viTranslations.META_INPUT_MAIL
  ],
  META_INPUT_NICK: [
    '昵称',
    '暱稱',
    ...
    '名前',
    '닉네임',
    viTranslations.META_INPUT_NICK
  ],
  META_INPUT_NOT_REQUIRED: [
    ...
    '任意',
    '선택',
    viTranslations.META_INPUT_NOT_REQUIRED
  ],
  META_INPUT_REQUIRED: [
    '必填',
    '必填',
    ...
    '必須',
    '필수',
    viTranslations.META_INPUT_REQUIRED
  ],
  PAGINATION_COUNT_PREFIX: [
    ...
    '合計 ',
    '총 ',
    viTranslations.PAGINATION_COUNT_PREFIX
  ],
  PAGINATION_COUNT_SUFFIX: [
    ...
    ' 件',
    '개',
    viTranslations.PAGINATION_COUNT_SUFFIX
  ],
  PAGINATION_GOTO_PREFIX: [
    ...
    'ページに移動',
    '이동할 페이지: ',
    viTranslations.PAGINATION_GOTO_PREFIX
  ],
  PAGINATION_GOTO_SUFFIX: [
    ...
    'ページ',
    '',
    viTranslations.PAGINATION_GOTO_SUFFIX
  ],
  PAGINATION_PAGESIZE: [
    '条/页',
    '條/頁',
    ...
    '件/ページ',
    '개/페이지',
    viTranslations.PAGINATION_PAGESIZE
  ],
  SUBMIT_CANCEL: [
    '取消',
    '取消',
  ...
  IMAGE_UPLOAD_PLACEHOLDER: [
    ...
    '画像のアップロード中',
    '이미지 업로드 중',
    viTranslations.IMAGE_UPLOAD_PLACEHOLDER
  ],
  IMAGE_UPLOAD_FAILED: [
    '图片上传失败',
    '圖片上傳失敗',
    ...
    '画像のアップロード失敗',
    '이미지 업로드 실패',
    viTranslations.IMAGE_UPLOAD_FAILED
  ],
  IMAGE_UPLOAD_FAILED_NO_CONF: [
    ...
    viTranslations.IMAGE_UPLOAD_FAILED_NO_CONF
  ],
  IMAGE_UPLOAD_PLEASE_WAIT: [
    ...
    viTranslations.IMAGE_UPLOAD_PLEASE_WAIT
  ],
  SUBMIT_SENDING: [
    '发送中',
    '發送中',
  ...
  TIMEAGO_MINUTES: [
    ...
    '分前',
    '분 전',
    viTranslations.TIMEAGO_MINUTES
  ],
  TIMEAGO_NOW: [
    '刚刚',
    '剛剛',
  ...
  TIMEAGO_SECONDS: [
    ...
    '秒前',
    '초 전',
    viTranslations.TIMEAGO_SECONDS
  ]
}
